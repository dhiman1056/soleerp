import{j as t}from"./vendor-query-CeXwUhWf.js";import{u as F,h as k,r as _}from"./vendor-react-CZc_Uusi.js";import{M as b}from"./MetricCard-pQuvX0aD.js";import{S as w,W as O}from"./WorkOrderForm-C54t115g.js";import{u as Q,e as q,L as R}from"./index-CMV7pFng.js";import{R as S}from"./ReceiveModal-Cdwm8CEl.js";import{f as n}from"./formatCurrency-Dm1mYVNt.js";import{f as u}from"./formatDate-Bs2wQqpU.js";import{b as C}from"./constants-Bge408wf.js";import"./index.esm-D2XN_8Pb.js";import"./Modal-DIN6xZK5.js";import"./useInventory-B3giy60B.js";import"./useBOM-BQYWzC0h.js";import"./useLocations-BM1UsIRi.js";const P=(r,s={})=>{const f=parseFloat(r.planned_qty||0)-parseFloat(r.received_qty||0),p=(s==null?void 0:s.company_name)||"ShoeERP Manufacturing",m=(s==null?void 0:s.company_address)||"",y=s!=null&&s.company_gstin?` | GSTIN: ${s.company_gstin}`:"",g=(s==null?void 0:s.logo_url)||"",x=Array.isArray(r.lines)?r.lines:[],v=x.reduce((o,i)=>{const c=parseFloat(i.consume_qty||0)*parseFloat(r.planned_qty||0);return o+c*parseFloat(i.rate_at_bom||0)},0),j=x.length>0?`
