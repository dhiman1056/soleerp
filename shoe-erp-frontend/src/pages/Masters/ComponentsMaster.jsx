    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label className="label">Component Code</label>
            <input
              value={isEdit ? editItem.comp_code : "Auto Generated (CMPNT-0001)"}
              disabled
...
export default function ComponentsMaster() {
  ...
  const { data, isLoading, refetch } = useComponents(params)
  const updateMut = useUpdateComponent()
